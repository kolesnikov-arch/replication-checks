...
| 2607.13716 | — | NOT RELEASED | artifact manifest cites internal paths (`docs/research/papers/cava`, `benchmarks/source-benchmark.mjs`); **no artifact URL.** The paper's nine links are all third-party standards and references (in-toto, Sigstore, OpenTelemetry, NIST, OWASP) |
